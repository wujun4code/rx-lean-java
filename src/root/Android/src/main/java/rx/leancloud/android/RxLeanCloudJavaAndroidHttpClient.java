...
import okhttp3.*;
import rx.leancloud.internal.HttpRequest;
import rx.leancloud.internal.HttpResponse;
...
public class RxLeanCloudJavaAndroidHttpClient implements IHttpClient {
    private static RxLeanCloudJavaAndroidHttpClient ourInstance = new RxLeanCloudJavaAndroidHttpClient();

    public static RxLeanCloudJavaAndroidHttpClient getInstance() {
        return ourInstance;
    }
